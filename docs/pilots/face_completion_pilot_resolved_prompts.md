...
OUTPUT: preferred one transparent 1254 x 1254 PNG. If exact-canvas output is unavailable, return one isolated RGBA source-art PNG for `docs/workflows/generator_source_transform.md`. filename: eyes_001_sheet_r1c1_dark_neutral.png
...
OUTPUT: preferred one transparent 1254 x 1254 PNG. If exact-canvas output is unavailable, return one isolated RGBA source-art PNG for `docs/workflows/generator_source_transform.md`. filename: eyebrows_001_sheet_r1c1.png
...
OUTPUT: preferred one transparent 1254 x 1254 PNG. If exact-canvas output is unavailable, return one isolated RGBA source-art PNG for `docs/workflows/generator_source_transform.md`. filename: mouth_001_closed_neutral.png
...
OUTPUT: preferred one transparent 1254 x 1254 PNG. If exact-canvas output is unavailable, return one isolated RGBA source-art PNG for `docs/workflows/generator_source_transform.md`. filename: expression_mark_001_pink_blush_strokes.png
...
OUTPUT: preferred one transparent 1254 x 1254 PNG. If exact-canvas output is unavailable, return one isolated RGBA source-art PNG for `docs/workflows/generator_source_transform.md`. filename: hair_front_003_silver_straight_bangs.png
