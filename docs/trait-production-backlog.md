...
| DG-009 | background | Moonlit arcane library with bookcases, arched window, cyan lights, desks, and abstract floor circle | `BG/background_003_arcane_library_reference.jpg` | DG-008 | `assets/backgrounds/background_003_arcane_library.png` | `prompts/17_native_1254_backgrounds.md` | candidate |
