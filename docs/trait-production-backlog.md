...
| DG-008 | background | Violet gothic sanctum with tall nave, stained glass, dark stone, candles, and central altar | `BG/background_002_violet_gothic_sanctum_reference.jpg` | DG-007 sequential approval | `assets/backgrounds/background_002_violet_gothic_sanctum.png` | `prompts/17_native_1254_backgrounds.md` | pending |
