...
| DG-010 | background | Navy-violet cloud dreamscape with crescent, hanging gold stars, and floating platform | `BG/background_004_crescent_star_dreamscape_reference.jpg` | DG-009 | `assets/backgrounds/background_004_crescent_star_dreamscape.png` | `prompts/18_native_1254_background_004_candidate.md` | candidate |
