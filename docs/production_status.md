...
Combination space is **43130880** against the 777 supply. A dry run produced 777 unique verified tokens and every one reads as clothed at thumbnail size.
...
`mouths` holds a single asset, making it the thinnest category in the collection.
...
- Registered production assets: **68**
- Distinct backlog assets: **230**
...
Backlog status tally: pending 162, candidate 0, QA-failed 0, approved 0, registered 69.
