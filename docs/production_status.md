...
- Registered production assets: **133**
- Distinct backlog assets: **160**
- Completed categories: **10 of 16** (backgrounds, hair_back, eyes, eyebrows, mouths, expression_marks, hair_front, hand_objects, front_auras, global_finish)
...
| `base_bodies` | 4 | 5 | 1 | in progress |
| `outfits` | 7 | 10 | 3 | in progress |
...
Backlog status tally: pending 0, candidate 0, QA-failed 27, approved 0, registered 134.
