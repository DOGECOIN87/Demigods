...
- Registered production assets: **47**
- Distinct backlog assets: **160**
- Completed categories: **5 of 16** (backgrounds, hair_back, base_bodies, hair_front, global_finish)

| Category | Registered | Backlog assets | Remaining | State |
|---|---|---|---|---|
| `backgrounds` | 8 | 8 | 0 | complete |
| `rear_auras` | 10 | 18 | 8 | in progress |
...
Backlog status tally: pending 113, candidate 0, QA-failed 0, approved 0, registered 48.
