...
- Registered production assets: **99**
- Distinct backlog assets: **160**
- Completed categories: **11 of 16** (backgrounds, rear_auras, back_accessories, hair_back, base_bodies, outfits, neck_accessories, hair_front, head_accessories, hand_objects, global_finish)
...
| `front_auras` | 1 | 2 | 1 | in progress |
| `global_finish` | 3 | 3 | 0 | complete |

Backlog status tally: pending 60, candidate 0, QA-failed 1, approved 0, registered 100.
