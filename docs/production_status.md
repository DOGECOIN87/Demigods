...
Combination space is **38400** against the 777 supply. A dry run produced 777 unique verified tokens and every one reads as clothed at thumbnail size.
...
- Registered production assets: **36**
- Distinct backlog assets: **174**
...
Backlog status tally: pending 138, candidate 0, QA-failed 0, approved 0, registered 37.
