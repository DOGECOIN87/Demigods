...
- Registered production assets: **85**
- Distinct backlog assets: **160**
- Completed categories: **10 of 16** (backgrounds, rear_auras, back_accessories, hair_back, base_bodies, outfits, neck_accessories, hair_front, front_auras, global_finish)
...
| `hand_objects` | 7 | 12 | 5 | in progress |
| `front_auras` | 2 | 2 | 0 | complete |
| `global_finish` | 3 | 3 | 0 | complete |

Backlog status tally: pending 75, candidate 0, QA-failed 0, approved 0, registered 86.
