...
4. Generate Background 003 only from its exact preserved JPEG reference; require the same binary, manual, and human approval gates before registration.
