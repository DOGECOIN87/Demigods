...
- Registered production assets: **153**
- Distinct backlog assets: **168** (plus 12 withdrawn by recorded decision)
- Completed categories: **12 of 15** (backgrounds, hair_back, base_bodies, outfits, eyes, eyebrows, mouths, expression_marks, hair_front, hand_objects, front_auras, global_finish)
- Withdrawn categories: neck_accessories
...
| `head_accessories` | 6 | 10 | 4 | in progress |
| `hand_objects` | 12 | 12 | 0 | complete |
| `front_auras` | 2 | 2 | 0 | complete |
| `global_finish` | 3 | 3 | 0 | complete |

Backlog status tally: pending 0, candidate 0, QA-failed 15, approved 0, registered 154, withdrawn 12.
