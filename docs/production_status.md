...
- Registered production assets: **132**
- Distinct backlog assets: **143** (plus 37 withdrawn by recorded decision)
- Completed categories: **10 of 12** (backgrounds, hair_back, base_bodies, outfits, eyes, eyebrows, mouths, expression_marks, hair_front, hand_objects)
- Withdrawn categories: neck_accessories, head_accessories, front_auras, global_finish

| Category | Registered | Backlog assets | Remaining | State |
|---|---|---|---|---|
| `backgrounds` | 8 | 8 | 0 | complete |
| `rear_auras` | 8 | 18 | 10 | in progress |
| `back_accessories` | 7 | 8 | 1 | in progress |
| `hair_back` | 8 | 8 | 0 | complete |
| `base_bodies` | 5 | 5 | 0 | complete |
| `outfits` | 26 | 26 | 0 | complete |
| `neck_accessories` | 0 | 0 | 0 | withdrawn |
| `eyes` | 24 | 24 | 0 | complete |
| `eyebrows` | 6 | 6 | 0 | complete |
| `mouths` | 12 | 12 | 0 | complete |
| `expression_marks` | 8 | 8 | 0 | complete |
| `hair_front` | 8 | 8 | 0 | complete |
| `head_accessories` | 0 | 0 | 0 | withdrawn |
| `hand_objects` | 12 | 12 | 0 | complete |
| `front_auras` | 0 | 0 | 0 | withdrawn |
| `global_finish` | 0 | 0 | 0 | withdrawn |

Backlog status tally: pending 0, candidate 0, QA-failed 11, approved 0, registered 133, withdrawn 37.
