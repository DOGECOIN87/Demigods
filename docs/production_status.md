...
- Registered production assets: **76**
- Distinct backlog assets: **160**
- Completed categories: **9 of 16** (backgrounds, rear_auras, back_accessories, hair_back, base_bodies, outfits, neck_accessories, hair_front, global_finish)
...
Backlog status tally: pending 84, candidate 0, QA-failed 0, approved 0, registered 77.
