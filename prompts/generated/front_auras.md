# front_auras — 2 assets to produce

Layer 15. Generated from the backlog; do not hand-edit.
...
## DG-145 — aura_front_001_orange_rising_flame

Dependency: Rear-aura representative and composite tests  
Path: `assets/front_auras/aura_front_001_orange_rising_flame.png`
...
SUBJECT: Orange rising foreground flame.
- source reference: AURA, lower row cell 7
- render this design only; do not substitute or embellish beyond the reference

PROPORTION: no width ceiling; must not cover the eyes or mouth.

OUTPUT: one transparent 1254 x 1254 PNG named aura_front_001_orange_rising_flame.png. No text, no alternate versions.
```

## DG-146 — aura_front_002_gold_light_pillars

Dependency: DG-145 representative test  
Path: `assets/front_auras/aura_front_002_gold_light_pillars.png`
...
SUBJECT: Gold vertical foreground light pillars.
- source reference: AURA, lower row cell 8
- render this design only; do not substitute or embellish beyond the reference

PROPORTION: no width ceiling; must not cover the eyes or mouth.

OUTPUT: one transparent 1254 x 1254 PNG named aura_front_002_gold_light_pillars.png. No text, no alternate versions.
```
