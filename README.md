...
- Live ledger: `docs/production-status.md`
...
.github/workflows/        Continuous repository validation
```
...
The validator performs complete binary decoding and checks PNG format, dimensions, transparency, visible bounds, category naming, sequential numbering, and manifest consistency.
