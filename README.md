...
**Phase 3 uses a locked 1254 × 1254 canvas. The collection renders: combination space 560701440, no active blocker. Hair recolours DG-169–175, face recolours DG-177–197 and the front-hair fringe DG-229–236 are interim placeholders pending painted designs.**
...
`mouths` went from one asset to thirteen on the same day (DG-237–248, `docs/qa/mouths_2026-07-27.md`). Every registered asset is catalogued in `docs/qa/composites/asset_catalogue.png`, regenerated by `python scripts/build_asset_catalogue.py`.
...
The registry currently contains **80 registered assets**: 4 backgrounds, 6 rear_auras, 8 hair_back, 5 base_bodies, 6 outfits, 13 eyes, 9 eyebrows, 13 mouths, 8 expression_marks, 8 hair_front.
