...
**Phase 3 uses a locked 1254 × 1254 canvas. The collection renders: combination space 38400, no active blocker. Outfits DG-164–168 and hair recolours DG-169–175 are interim placeholders pending painted designs.**
...
The registry currently contains **36 registered assets**: 4 backgrounds, 6 rear_auras, 8 hair_back, 5 base_bodies, 5 outfits, 8 expression_marks.

Backlog: **174** distinct assets across 16 categories; **2** complete (base_bodies, expression_marks).
