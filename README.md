...
**Phase 3 uses a locked 1254 × 1254 canvas. The collection renders: combination space 4492800, no active blocker. Hair recolours DG-169–175 and face recolours DG-177–197 are interim placeholders pending painted designs.**
...
The registry currently contains **60 registered assets**: 4 backgrounds, 6 rear_auras, 8 hair_back, 5 base_bodies, 6 outfits, 13 eyes, 9 eyebrows, 1 mouths, 8 expression_marks.

Backlog: **198** distinct assets across 16 categories; **2** complete (base_bodies, expression_marks).
