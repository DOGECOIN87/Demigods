...
The registry currently contains **16 registered assets**: 4 backgrounds, 6 rear_auras, 1 hair_back, 5 base_bodies.

Backlog: **156** distinct assets across 16 categories; **1** complete (base_bodies).
