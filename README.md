...
**Phase 3 uses a locked 1254 × 1254 canvas. The collection renders: combination space 43130880, no active blocker. Hair recolours DG-169–175, face recolours DG-177–197 and the front-hair fringe DG-229–236 are interim placeholders pending painted designs.**
...
The registry currently contains **68 registered assets**: 4 backgrounds, 6 rear_auras, 8 hair_back, 5 base_bodies, 6 outfits, 13 eyes, 9 eyebrows, 1 mouths, 8 expression_marks, 8 hair_front.

Backlog: **230** distinct assets across 16 categories; **2** complete (base_bodies, expression_marks).
