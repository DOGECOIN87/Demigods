...
Outfits are six painted robes (DG-199–204), which replaced the interim procedural coats on 2026-07-27. See `docs/qa/painted_outfits_2026-07-27.md` — including the measurement showing that any sleeved outfit hides 34–83% of what distinguishes the five base poses.
...
Backlog: **243** distinct assets across 16 categories; **2** complete (base_bodies, expression_marks).
