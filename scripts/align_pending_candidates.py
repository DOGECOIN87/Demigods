...
HEAD_ACCESSORIES: list[dict[str, Any]] = [
    ...
    dict(id="DG-127", name="head_accessory_005_silver_winged_circlet",
         ...
         seat="band across the forehead with the wings reaching the hair at the temples"),
    ...
    dict(id="DG-129", name="head_accessory_007_silver_drop_circlet",
         ...
         width=420, top_y=250, height=None,
         seat="band spanning the hair with its arms tucked into it at the temples, drop centred"),
    ...
    dict(id="DG-132", name="head_accessory_010_gold_low_circlet",
         ...
         width=420, top_y=212, height=None, front_arc=True,
         seat="front band spanning the hair; the ring's far side passes behind the head"),
]
