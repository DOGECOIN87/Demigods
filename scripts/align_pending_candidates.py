...
HEAD_ACCESSORIES: list[dict[str, Any]] = [
    dict(id="DG-123", name="head_accessory_001_gold_pointed_crown",
         ...
         width=390, top_y=129, height=190,
         seat="crown seated on the skull dome, band clear of the eyes"),
    ...
    dict(id="DG-126", name="head_accessory_004_black_curved_horns",
         ...
         seat="horn bases on the skull dome at the brow line, fully clear of the eyes"),
    dict(id="DG-127", name="head_accessory_005_silver_winged_circlet",
         ...
         width=440, top_y=129, height=190,
         seat="band just above the brow with the wings reaching the hair at the temples"),
    ...
    dict(id="DG-129", name="head_accessory_007_silver_drop_circlet",
         ...
         width=420, top_y=232, height=120,
         seat="band spanning the hair with its arms tucked into it, drop centred above the eyes"),
    dict(id="DG-130", name="head_accessory_008_translucent_white_veil",
         ...
         width=460, top_y=180, height=None,
         seat="arch resting on the crown with the drapes framing the face"),
    ...
    dict(id="DG-132", name="head_accessory_010_gold_low_circlet",
         ...
         width=420, top_y=200, height=None, front_arc=True,
         seat="front band spanning the hair above the brow; the ring's far side passes behind the head"),
]
