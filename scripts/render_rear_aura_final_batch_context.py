#!/usr/bin/env python3
"""Render deterministic full-context QA composites for the final rear-aura batch."""
from pathlib import Path
from PIL import Image, ImageDraw

ROOT = Path(__file__).resolve().parents[1]
OUT_DIR = ROOT / "docs/qa/composites"
SHEET_PATH = ROOT / "docs/qa/rear_auras_014_015_017_full_context_sheet.png"
AURA_DIR = ROOT / "incoming/rear_auras_014_015_017"
...
AURAS = [
    "aura_rear_014_ice_crystal_ring.png",
    "aura_rear_015_smoke_void_ring.png",
    "aura_rear_017_water_splash_ring.png",
]
BACKGROUNDS = [
